...
?>
              ...
              <tr class="NewRow" id="taskrow<?php echo $newRowId;?>">
                ...
                <td  class="fixedWidth">
                     <input style="width:100%" onchange="drawGanntBars();" type="text" id="startDate<?php echo $newRowId;?>" value="" >
                </td>
                <td  class="fixedWidth">
                     <input style="width:100%" onchange="drawGanntBars();" type="text" id="endDate<?php echo $newRowId;?>" value="" >
                </td>
                <td  class="fixedWidth" style="text-align:center">
