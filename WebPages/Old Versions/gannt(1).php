...
?>
                 <tr id="taskrow<?php echo $task["id"];?>">
                   ...
                   <td class="fixedWidth">
                     <input type="text" style="width:100%" id="startDate<?php echo $task["id"];?>" value="<?php echo $task["startDate"];?>" 
                      onchange="drawGanntBars();saveChangeToTask(<?php echo $task["id"];?>)"></td>
                   </td>
                   <td class="fixedWidth">
                     <input type="text" style="width:100%"  id="endDate<?php echo $task["id"];?>" value="<?php echo $task["endDate"];?>" 
                      onchange="drawGanntBars();saveChangeToTask(<?php echo $task["id"];?>)"></td>
                   </td>
